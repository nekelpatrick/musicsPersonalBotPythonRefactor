...
class DownloadView(APIView):
    ...
    @swagger_auto_schema(
        operation_description="Download YouTube videos and upload to S3",
        request_body=openapi.Schema(
            type=openapi.TYPE_STRING,
            description="Text containing YouTube URLs",
            example="[9/7 12:08] Rodolfo Nekel: https://youtu.be/rYNwKR_A-DI [9/7 14:04] Rodolfo Nekel: https://youtu.be/juVyqXIKArY [9/7 14:07] Rodolfo Nekel: https://youtu.be/ncRNy0JD6R8"
